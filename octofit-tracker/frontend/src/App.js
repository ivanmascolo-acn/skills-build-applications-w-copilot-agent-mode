      ...
      <div className="card shadow mb-4">
        <div className="card-body">
          <Routes>
            ...
            <Route path="/" element={<div className="text-center"><h1 className="display-4">Benvenuto in OctoFit Tracker!</h1><p className="lead">Seleziona una sezione dal menu.</p></div>} />
          </Routes>
        </div>
      </div>
    </div>
